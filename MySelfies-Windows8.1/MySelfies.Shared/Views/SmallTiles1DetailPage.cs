...
{
    public sealed partial class SmallTiles1DetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;
        public DetailViewModel<InstagramDataConfig, InstagramSchema> ViewModel { get; set; }

        public SmallTiles1DetailPage()
               : base(true)
        {
            this.ViewModel = new DetailViewModel<InstagramDataConfig, InstagramSchema>(new SmallTiles1Config());
