...
{
    public sealed partial class BigTilesDetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;
        public DetailViewModel<InstagramDataConfig, InstagramSchema> ViewModel { get; set; }

        public BigTilesDetailPage()
               : base(true)
        {
            this.ViewModel = new DetailViewModel<InstagramDataConfig, InstagramSchema>(new BigTilesConfig());
