...
{
    public sealed partial class BigTiles1DetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;
        public DetailViewModel<InstagramDataConfig, InstagramSchema> ViewModel { get; set; }

        public BigTiles1DetailPage()
               : base(true)
        {
            this.ViewModel = new DetailViewModel<InstagramDataConfig, InstagramSchema>(new BigTiles1Config());
