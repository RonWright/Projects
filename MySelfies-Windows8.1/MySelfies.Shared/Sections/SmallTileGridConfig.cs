...
{
    public class SmallTileGridConfig : SectionConfigBase<InstagramDataConfig, InstagramSchema>
    {
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get
            {
                return NavigationInfo.FromPage("SmallTileGridListPage");
            }
        }
        ...
        public override ListPageConfig<InstagramSchema> ListPage
        {
            get
            {
                return new ListPageConfig<InstagramSchema>
                {
                    ...
                    NavigationInfo = (item) =>
                    {
                        return NavigationInfo.FromPage("SmallTileGridDetailPage", true);
                    }
                };
            }
        }
