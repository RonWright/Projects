...
{
    public class BigTilesConfig : SectionConfigBase<InstagramDataConfig, InstagramSchema>
    {
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get
            {
                return NavigationInfo.FromPage("BigTilesListPage");
            }
        }
        ...
        public override ListPageConfig<InstagramSchema> ListPage
        {
            get
            {
                return new ListPageConfig<InstagramSchema>
                {
                    ...
                    NavigationInfo = (item) =>
                    {
                        return NavigationInfo.FromPage("BigTilesDetailPage", true);
                    }
                };
            }
        }
