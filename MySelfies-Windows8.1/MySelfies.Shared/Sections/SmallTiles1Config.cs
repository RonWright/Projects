...
{
    public class SmallTiles1Config : SectionConfigBase<InstagramDataConfig, InstagramSchema>
    {
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get
            {
                return NavigationInfo.FromPage("SmallTiles1ListPage");
            }
        }
        ...
        public override ListPageConfig<InstagramSchema> ListPage
        {
            get
            {
                return new ListPageConfig<InstagramSchema>
                {
                    ...
                    NavigationInfo = (item) =>
                    {
                        return NavigationInfo.FromPage("SmallTiles1DetailPage", true);
                    }
                };
            }
        }
