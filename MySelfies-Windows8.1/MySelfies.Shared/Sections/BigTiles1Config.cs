...
{
    public class BigTiles1Config : SectionConfigBase<InstagramDataConfig, InstagramSchema>
    {
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get
            {
                return NavigationInfo.FromPage("BigTiles1ListPage");
            }
        }
        ...
        public override ListPageConfig<InstagramSchema> ListPage
        {
            get
            {
                return new ListPageConfig<InstagramSchema>
                {
                    ...
                    NavigationInfo = (item) =>
                    {
                        return NavigationInfo.FromPage("BigTiles1DetailPage", true);
                    }
                };
            }
        }
