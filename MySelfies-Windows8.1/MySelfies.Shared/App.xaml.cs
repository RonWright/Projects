...
using MySelfies.Services;

#if WINDOWS_APP
using Windows.System;
using Windows.UI.Core;
using Windows.UI.ApplicationSettings;
using MySelfies.AppFlyouts;
#endif
...
namespace MySelfies
{
    ...
    {
        private Guid APP_ID = new Guid("9259782c-dcd0-44e9-95ca-143011c76945");
        public const string APP_NAME = "MySelfies";
        ...
        private void UpdateAppTiles()
        {
            ...
            {
                TileServices.CreateFlipTile(@"My Selfies", @"All About ME");
